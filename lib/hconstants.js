...
CONST.DEFAULT_ERROR_RETRY_TIME = 1000; // 1s multiplied by the order number of retry
CONST.DEFAULT_ERROR_RETRY_NUMBER = 5;

CONST.DEFAULT_HBASE_CLIENT_PAUSE = 100; // 0.1s
CONST.DEFAULT_HBASE_RETRIES_NUMBER = 35;
